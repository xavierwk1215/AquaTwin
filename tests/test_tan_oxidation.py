...
def test_apply_tan_oxidation_moves_mass_to_nitrite():
    state = TankState(
    ...
    assert result.chemical_state.nitrite_n_mass_mg == 10.0
...
def test_apply_tan_oxidation_preserves_total_nitrogen_mass():
    state = TankState(
        chemical_state=ChemicalState(
            organic_n_mass_mg=90.0,
            tan_n_mass_mg=20.0,
...
def test_apply_tan_oxidation_rejects_negative_fraction():
    state = TankState(
        chemical_state=ChemicalState(
            organic_n_mass_mg=90.0,
            tan_n_mass_mg=20.0,
...
def test_apply_tan_oxidation_rejects_fraction_above_one():
    state = TankState(
        chemical_state=ChemicalState(
            organic_n_mass_mg=90.0,
            tan_n_mass_mg=20.0,
